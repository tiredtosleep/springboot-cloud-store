...
public class JwtUtils {
     ...
     * @return
     */
    public static UserInfo getInfoFromToken(PublicKey publicKey, String token) {
     ...
     * @throws Exception
     */
    public static UserInfo getInfoFromToken(byte[] publicKey, String token) throws Exception {
        Jws<Claims> claimsJws = parseToken(publicKey, token);
        Claims body = claimsJws.getBody();
        return new UserInfo(
                ObjectUtils.toLong(body.get(JwtConstants.JWT_KEY_ID)),
